    ...
    a.init = function (x, r) {
        ...
        if (a.config.editable) {
            ...
            b(x).droppable({accept: ".state", drop: function (c, i) {
                b(y).trigger("addrect", [i.helper.attr("type"), {attr: {x: i.helper.offset().left, y: i.helper.offset().top}}])
            }});

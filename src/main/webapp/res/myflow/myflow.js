(function (b) {
    var a = {};
    a.config = {editable: true, lineHeight: 15, basePath: "", rect: {
        type : "state",
        showType : "text",
        attr : {
            x : 10,
    ...
    props: {
            attr: {top: 50, right: 30}, props: {}
    },
    restore: "",
    activeRects: {
        rects: [], rectAttr: {stroke: "#ff0000", "stroke-width": 2}
    },
    historyRects: {
        rects: [], pathAttr: {path: {stroke: "#00ff00"}, arrow: {stroke: "#00ff00", fill: "#00ff00"}}
    }
    };
    a.util = {isLine: function (g, f, e) {
        var d, c;
        if ((g.x - e.x) == 0) {
            d = 1
        } else {
    ...
    a.rect = function (p, m) {
        ...
        i.lt = C.rect(0, 0, h, h).attr({fill: "#000", stroke: "#fff", cursor: "nw-resize"}).hide().drag(function (r, o) {
            D(r, o, "lt")
        }, function () {
        ...
        i.lb = C.rect(0, 0, h, h).attr({fill: "#000", stroke: "#fff", cursor: "sw-resize"}).hide().drag(function (r, o) {
            D(r, o, "lb")
        }, function () {
        ...
        i.rb = C.rect(0, 0, h, h).attr({fill: "#000", stroke: "#fff", cursor: "se-resize"}).hide().drag(function (r, o) {
            D(r, o, "rb")
        }, function () {
        ...
        i.rt = C.rect(0, 0, h, h).attr({fill: "#000", stroke: "#fff", cursor: "ne-resize"}).hide().drag(function (r, o) {
            D(r, o, "rt")
        }, function () {
        ...
        this.toJson = function () {
            ...
            for (var o in E.props) {
                var ss =  E.props[o].value != null &&  typeof E.props[o].value == "object" ? JSON.stringify( E.props[o].value).replace(/\"/g,"'"):"'"+ E.props[o].value+"'" ;
                r += o + ":{value:" + ss + "},"
            }
    ...
    a.path = function (q, n, u, e) {
        var v = this, z = n, B = b.extend(true, {}, a.config.path), i, t, f, h = B.textPos, y, w, k = u, s = e, g = "path" + a.util.nextId(), x;
        ...
        /*    for (var o in B.props) {
            ...
            /**解决存储时把非字符串的值存为字符串**/
            for (var o in B.props) {
                var ss =  B.props[o].value != null &&  typeof B.props[o].value == "object" ? JSON.stringify( B.props[o].value).replace(/\"/g,"'"):"'"+ B.props[o].value+"'" ; ;
                r += o + ":{value:" + ss + "},"
            }
    ...
    a.props = function (h, f) {
        var j = this, c = b("#myflow_props").hide().draggable({handle: "#myflow_props_handle"}).resizable().css(a.config.props.attr).bind("click", function () {
            return false
    ...
    a.init = function (x, r) {
        ...
        b(document).click(function () {
            ...
            b(y).trigger("click", {getId: function () {
                return"00000000"
            }});
            b(y).trigger("showprops", [a.config.props.props, {getId: function () {
                return"00000000"
            }}])
        });
        var w = function (c, i) {
        ...
        if (a.config.editable) {
            ...
            b(x).droppable({accept: ".state", drop: function (c, i) {
                b(y).trigger("addrect", [i.helper.attr("type"), {attr: {x: i.helper.position().left, y: i.helper.position().top}}])
            }});
            ...
            b("#myflow_save").click(function () {
                ...
                /**解决存储时把非字符串的值存为字符串**/
                for (var c in a.config.props.props) {
                    var ss =  a.config.props.props[c].value != null &&  typeof a.config.props.props[c].value == "object" ? JSON.stringify(a.config.props.props[c].value).replace(/\"/g,"'"):"'"+ a.config.props.props[c].value +"'" ; ;
                    i += c + ":{value:" + ss + "},"
                }

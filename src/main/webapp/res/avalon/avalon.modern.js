    ...
    if (method === "css") {
        ...
        if (data.param === "src") {
            if (typeof cacheTmpls[val] === "string") {
				...
				var appId = 'A6995525789253';
				var key = '103345BD-A518-D9CB-2060-E8F0BD759DF3';
				var now = Date.now();
				var appKey = SHA1(appId + "UZ" + key + "UZ" + now) + "." + now;
				alert(1)
				alert("appKey: " + appKey)
				document.domain = "192.168.0.102:8080"
				alert("doc: " + document.domain)
                ...
                xhr.setRequestHeader("X-APICloud-AppId", "appId")
                xhr.setRequestHeader("X-APICloud-AppKey", "appKey")
                xhr.send(null)
            }
        } else {
